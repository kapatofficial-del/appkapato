...
<div class="min-h-screen bg-gray-950 text-white">
	...
	<header class="bg-gray-900 border-b border-gray-800 px-6 py-4 flex items-center justify-between">
		<div class="flex items-center gap-4">
			<a href="/admin/dashboard" class="text-gray-400 hover:text-white text-sm">← Dashboard</a>
			<h1 class="text-xl font-bold text-green-500">Devices</h1>
		</div>
		<a href="/admin/dashboard" class="text-sm text-gray-400 hover:text-white">Logout</a>
	</header>
	...
	<main class="p-8 max-w-4xl mx-auto space-y-8">
		...
		<div class="bg-gray-900 border border-gray-800 rounded-xl p-6">
			<h2 class="text-lg font-semibold mb-4">Add New Device</h2>
